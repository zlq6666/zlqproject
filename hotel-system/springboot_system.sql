...
CREATE TABLE `sys_log` (
  ...
  `class_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exception` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=414 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统日志信息表';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1', '2022-12-02 12:55:05.000000', '我是一名管理员', '1', '2023-03-11 04:27:20.513000', 'E10ADC3949BA59ABBE56E057F20F883E', '系统管理员', '男', '1', 'admin', '379533177@qq.com', 'f7700bc5-47dc-4a65-93d4-8856559c4e45.png', '1');
